...
INSERT INTO `producto` (`idproducto`,`nomprod`,`idmarca`,`idtipoproducto`,`prec`,`stkmin`,`stkmax`) VALUES 
 ...
 (8,'Arabitos uno',6,1,'580.96',34,55),
 (9,'dedsoids kjj',4,1,'34.00',6,6),
 (10,'Lcd 27\' con 24micrs',17,6,'652.36',1,3),
 (11,'de 58x',25,2,'50.00',1,5);
...
INSERT INTO `usuario` (`idusuario`,`usr`,`psw`) VALUES 
 ...
 (2,'Silva','289dff07669d7a23de0ef88d2f7129e7');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;


--
-- Definition of function `FncAcceso`
--

DROP FUNCTION IF EXISTS `FncAcceso`;
...
begin
  return (select (if((select count(*) from usuario where usr=us and psw=md5(pw))=1,'1','0')));
 end $$
