...
public class Producto {
    ...
    public int idprod, idmrc, idtpoprd, stmin, stmax;
    public String desc;
    public double prec;
    ...
    public String EliminarProducto(){
        try {
            if(cntrl.VerificaConsulta("select * from detallecomproprove where idproducto = "+idprod)){
                return "El producto "+ desc + " no puede eliminarse, tiene productos en el detalle comprobante";
            }else{
                cntrl.EditarRegistro("delete from producto where idproducto = "+ idprod);
                return "Eliminado";
            }
        } catch (Exception e) {
            return "Error";
