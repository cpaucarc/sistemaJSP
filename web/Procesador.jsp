...
<%
  switch(Integer.parseInt(request.getParameter("ev"))){
      ...
      case 2:{
       String mrc=request.getParameter("mrc");   int cont=0;       
        ...
        while(control.Base.rs.next()){cont++; 
      ...
      case 3:{              
       ...
       catch(Exception e){out.print(control.Sql);}
       break;
      }
      case 4:{
      ...
      case 7:{  /*************Mostrar Productos*************/
       String pr=request.getParameter("prd");   int cont=0;       
      ...
      case 9:{ //Seleccionar Producto        
        ...
        0, 0, "", 0.0, 0, 0);String rst[]= prod.SeleccionarProducto();
      ...
      case 15:{  //Seleccionar producto ingresar
        ...
        try{
         ...
         if(control.Base.rs.next()){
          JSONObject json = new JSONObject();
          json.put("idpr",control.Base.rs.getString(1));json.put("nompr",control.Base.rs.getString(2));
